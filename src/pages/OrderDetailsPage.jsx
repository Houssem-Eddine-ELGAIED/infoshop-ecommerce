import React from 'react';  // `useEffect` a été supprimé, car non utilisé
...
const OrderDetailsPage = () => {
  ...
  // Simuler un paiement réussi pour l'exemple
  const paymentHandler = async () => {
    try {
      // Ici on simule le paiement et on marque l'ordre comme payé
      const paymentDetails = {
        id: 'simulatedPaymentId', // ID de paiement simulé
        status: 'paid',
